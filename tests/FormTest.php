...
class FormTest extends \BootPress\HTMLUnit\Component
{
    public static function setUpBeforeClass()
    {
        ...
        Page::html(array('testing' => true, 'suffix' => '.html'), $request, 'overthrow');
    }
    ...
    {
        $form = new Form('test');
        $this->assertNull($form->eject()); // No $_GET['submitted'] value

        // Test a submitted form
        $request = Request::create('http://website.com/path/to/folder.html', 'GET', array('submitted' => 'test'));
        Page::html(array('testing' => true, 'suffix' => '.html'), $request, 'overthrow');
        $form = new Form('test');
        $this->assertNull($form->eject());

        // Reset Page to previous settings
        $request = Request::create('http://website.com/path/to/folder.html', 'GET', array('foo' => 'bar'));
        Page::html(array('testing' => true, 'suffix' => '.html'), $request, 'overthrow');
    }
